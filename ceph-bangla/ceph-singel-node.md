...
| Container Runtime | **Docker** (আপনার রিকোয়ারমেন্ট) |
| OSD Disk | `/dev/sdb` (100GB, Unpartitioned) |
...
## 📦 ধাপ ২: Cephadm ইন্সটল (Official Method)

Ubuntu 24.04 এর জন্য `apt` পদ্ধতি ব্যবহার করাই সবচেয়ে সহজ ও নির্ভরযোগ্য।

```bash
# Cephadm প্যাকেজ ইন্সটল
sudo apt install -y cephadm

# ভেরিফাই করুন cephadm ইন্সটল হয়েছে কিনা
which cephadm
...
> ⚠️ **নোট:** যদি `apt` পদ্ধতিতে সমস্যা হয়, তাহলে `curl` মেথড ব্যবহার করতে পারেন:
> ```bash
> CEPH_RELEASE=squid  # অথবা reef/tentacle (latest stable)
